...
* File Name: app.h
*
* Description: This is header file for the PMG1 MCU USB-PD Sink Code Example.
 ...
 * @return 1 in case of success, 0 in case of task handling error.
 */
uint8_t app_fault_handler_task(cy_stc_pdstack_context_t *ptrPdStackContext);
/**
...
/**
 * @brief This function waits for a RTOS event to trigger. It will be blocked until
 * any event will be set.
 * @param stack_ctx PD Stack context pointer.
 * @return bool
 * Return true if event received, otherwise false.
 */
bool fault_rtos_event_wait(cy_stc_pdstack_context_t *stack_ctx);
/**

...
* File Name: app.c
*
* Description: This is source code for the PMG1 MCU USB-PD Sink Code Example.
               ...
               cy_en_pdstack_app_evt_t evt, const void* dat)
{
    ...
    switch(evt)
    {
        ...
        case APP_EVT_PD_CONTRACT_NEGOTIATION_COMPLETE:
            ...
            {
                Cy_PdUtils_SwTimer_Start(ptrPdStackContext->ptrTimerContext, ptrPdStackContext,
							GET_APP_TIMER_ID(ptrPdStackContext, APP_EPR_MODE_TIMER), APP_EPR_MODE_EXIT_TIMER_PERIOD, epr_mode_exit_cb);
            }
#endif /* CY_PD_EPR_ENABLE && (!CY_PD_SOURCE_ONLY) */
            break;
